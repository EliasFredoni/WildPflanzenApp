...
export default function Verwendung({navigation}) {
  return (
...
<View style={styles.littleContainer}>
    ...
    <Text style={styles.text} onPress={() => navigation.navigate("Blatt")}>BLATT</Text>
    ...
    <Text style={styles.text} onPress={() => navigation.navigate("Blüte")}>BLÜTE</Text>
...
<View style={styles.littleContainerTwo}>
    ...
    <Text style={styles.text}onPress={() => navigation.navigate("Stamm")} >STÄNGEL/WURZEL</Text>
    ...
    <Text style={styles.text} onPress={() => navigation.navigate("Knospe")}>KNOSPE</Text>
    <Image source={require('../assets/knospen.png')} style={styles.image}></Image>
    </View>
    </TouchableOpacity>
</View>
